...
const Register = () => {
  ...
  const [passwordMatch, setPasswordMatch] = useState(true); // State for password validation
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.password !== formData.confirmPassword) {
      ...
      setPasswordMatch(true); // Reset passwordMatch state if passwords match
    }
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen bg-gray-100">
      ...
      {/* Form Container */}
      <div ref={formRef} className="mt-10 p-6 bg-white rounded-lg shadow-lg w-96 mb-50">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          {/* Register Button */}
          <Button type="submit" className="bg-blue-600 hover:bg-blue-700 transition duration-300 mb-20">Register</Button>
        </form>
      </div>
      <div>
      {/* Footer */}
      <div className="w-full text-black text-center py-2 px-10 mt-20">
